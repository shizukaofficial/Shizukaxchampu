...
BOT_USERNAME = getenv("BOT_USERNAME" , "shizukaXmusicXrobot")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/shizukaofficial/Shizukaxchampu",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/shizukaofficial/Shizukaxchampu")
